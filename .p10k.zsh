...
# Generated by Powerlevel10k configuration wizard on 2024-11-14 at 13:53 CST.
...
() {
  ...
  # https://stackoverflow.com/questions/59500000/i-have-a-problem-with-it-when-i-use-powerlevel10k-which-is-a-theme-for-zsh
  # Disables Git prompt in $HOME; uncomment to ignore Git in ~
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%A, %d-%m-%y %H:%M:%S %p}'
