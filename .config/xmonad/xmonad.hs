...
myStartupHook :: X ()
myStartupHook = do
    spawnOnce "trayer --edge top --align right --monitor 0 --widthtype request --heighttype request --height 20 --alpha 0 --transparent true --tint 0x292d3e --SetDockType false --SetPartialStrut false --iconspacing 5 --margin 760 &>/dev/null & disown"
    setWMName "LG3D"
...
--  -> nf-seti-config
-- $ [ " 󰈹 ", "  ", "  ", " 󱍙 ", "  ", "  ", "  ", "  ", " 󰌨 " ]
--    $ [ "xf0239", "xe8da", "xe795", "xf1359", "xe710", "xe7b0", "xe615", "xf03e", "xf0328" ]
    $ [ "www", "dev", "term", "folder", "stackoverflow", "docker", "system", "media", "misc" ]
  where
