...
Simple colorful terminal prompt theme (inspired by powerlevel13k zsh theme, based on Brainy theme).
...
`__PB13K_PROMPT_LOCAL_USER_INFO=false`
...
`__PB13K_TOP_LEFT="dir scm"`

`__PB13K_TOP_RIGHT="exitcode cmd_duration user_info python ruby todo clock battery"`
